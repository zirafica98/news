...
const mreze = () => import('./pages/mreze-page').then((m) => m.MrezePage);
...
export const routes: Routes = [
  ...
  { path: 'mreze', data: naslov('nav.mreze'), loadComponent: mreze },
  ...
  { path: 'izdanje/:datum/mreze', data: naslov('nav.mreze'), loadComponent: mreze },
