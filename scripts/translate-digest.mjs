...
- Do NOT change keys, enum values (kategorija, tip, vaznost, izSrbije, tezina, vikendProjekat, jacina, platforma), account names and handles, numbers, prices, dates or URLs.
